...
for i = 8:L
    Record_GyrAngle1(i,1) = sqrt( sum(Gyrx(i-1+1:i,1))^2+sum(Gyry(i-1+1:i,1))^2+sum(Gyrz(i-1+1:i,1))^2 );
    Record_GyrAngle4(i,1) = sqrt( sum(Gyrx(i-4+1:i,1))^2+sum(Gyry(i-4+1:i,1))^2+sum(Gyrz(i-4+1:i,1))^2 )/4;
    Record_GyrAngle8(i,1) = sqrt( sum(Gyrx(i-8+1:i,1))^2+sum(Gyry(i-8+1:i,1))^2+sum(Gyrz(i-8+1:i,1))^2 )/8;       
end
